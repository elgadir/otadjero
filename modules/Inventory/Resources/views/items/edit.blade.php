        ...
        {!! Form::model($item, [
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    {{ Form::selectGroup('unit', trans('inventory::general.unit'), 'fas fa-box-open', $units, $item->inventory()->value('unit') ?? old('default_unit', setting('inventory.default_unit')), ['show' => 'form.track_inventory == true', 'required' => 'required']) }}

                    {{ Form::textGroup('sku', trans('inventory::general.sku'), 'fa fa-key', ['show' => 'form.track_inventory == true', 'required' => 'required'], $sku) }}

                    {{ Form::textGroup('barcode', 'Barcode', 'barcode', ['show' => 'form.track_inventory == true'], $item->inventory()->value('barcode')) }}
