            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <ul class="d-flex list-unstyled mb-0">
                        <li class="pl-2">
                            @money($deal->amount, $deal->currency_code, true)
                        </li>
                        <li class="pl-2">
                ...
                <div class="col-md-6 text-right pl-4">
                    <div style="float:right;">
                        <a href="javascript:void(0);"
                           ...
                           {{ ($deal->status == "open" || $deal->status == null) ? '' : 'd-none' }}"
            ...
            <div class="card company">
                ...
                @if(!empty($company))
                    ...
                    <div class="card-header border-bottom-0 show-transaction-card-header">
                        ...
                        <a class="float-right text-xs">{{ $company->contact->address }}</a>
                    </div>
                @endif
            </div>
                        ...
                        @foreach($agents as $agent)
                            <div class="card-header border-bottom-0 show-transaction-card-header">
                                ...
                                <div class="dropdown float-right">
                                    <a href="javascript:void(0);" id="delete-agent" class="btn btn-neutral btn-sm text-light items-align-center p-2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-ellipsis-h text-muted"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                                        {!! Form::deleteLink($agent, company_id() . '/crm/modals/deals/' . $deal->id . '/agents', 'crm::general.agents') !!}
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <table class="table table-flush table-hover">
                            <thead class="thead-light">
                                <tr class="row table-head-line">
                                    ...
                                    <th class="col-md-2 text-center">{{ trans('general.name') }}</th>
                                ...
                                @if($item->done == false)
                                    <tr class="row align-items-center border-top-1">
                                        <td class="col-md-2 border-0 text-center">
                                            <a href="{{ route('crm.deal.activities.done', $item->id)}}"
                                                class="btn btn-outline-success rounded-circle btn-icon-only btn-sm mr-2"
                                                data-toggle="tooltip"
                                                data-placement="right"
                                                title="{{ trans('crm::general.done') }}"
                                            >
                                                <span class="btn-inner--icon mt-2 d-block"><i class="fas fa-check"></i></span>
                                            </a>
                                        </td>
                                        ...
                                        <td class="col-md-2 border-0 text-center">
                                            <div class="dropdown">
                                                <a class="btn btn-neutral btn-sm text-light items-align-center p-2" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="fa fa-ellipsis-h text-muted"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" @click="onEditActivity('{{ trans('general.title.edit', ['type' => trans_choice('crm::general.activities', 1)])}}', {{ $deal->id }}, {{ $item->id }})" href="javascript:void(0);">
                                                        {{ trans('general.edit') }}
                                                    </a>
                                                    <div class="dropdown-divider"></div>
                                                    {!! Form::deleteLink($item, company_id() . '/crm/modals/deals/' . $deal->id . '/activities', 'crm::general.activities') !!}
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="col-md-2 border-0 text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <div class="dropdown-divider"></div>
                                                    {!! Form::deleteLink($item, company_id() . '/crm/modals/deals/' . $deal->id . '/competitors', 'crm::general.competitors') !!}
                                                    @endpermission
                                                </div>
                                            </div>
                                        </td>
