    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <div class="card-header border-bottom-0 show-transaction-card-header">
                ...
                <a class="float-right text-xs">{{ $contact->born_at }}</a>
            </div>
        ...
        <a href="{{ Route('crm.contacts.edit', $contact->id) }}" class="btn btn-primary btn-block">
                    ...
                    <div class="card-header border-bottom-0 show-transaction-card-header">
                        ...
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                                {!! Form::deleteLink($contactCompany, company_id() .  '/crm/modals/contact/' . $contact->id . '/company', 'crm::general.companies') !!}
                            </div>
                        </div>
                    </div>
                    @endforeach
